...
contract("testjoin",accounts => {
    ...
    let pb = await web3.eth.getBalance(paddr);
    console.log("paddr eth balance is: "+web3.utils.fromWei(pb,"ether"));
    await p.join(web3.utils.toWei('5000','ether'),false,{from:accounts[1],value:txFeeJoin});
    console.log("paddr eth balance is: "+web3.utils.fromWei(pb,"ether"));
